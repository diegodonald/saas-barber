...
import { DashboardMetrics, getDashboardMetrics } from '../services/appointmentApi';
...
const CalendarIcon = () => (
  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      ...
      strokeWidth={2}
      d="M8 7V3a4 4 0 118 0v4m-4 12v-2m0 0V9m0 2h.01"
    />
  </svg>
);
...
export const DashboardPage: React.FC = () => {
  ...
  const getNavigationItems = () => {
    const baseItems = [{ id: 'dashboard', name: 'Dashboard', icon: CalendarIcon }];
  ...
  const renderDashboardContent = () => {
    if (currentView === 'schedule') {
      return (
        <div data-testid="schedule-manager">
          <ScheduleManager onClose={() => setCurrentView('dashboard')} />
        </div>
      );
    }
    ...
    if (currentView === 'services') {
      return (
        <div data-testid="barber-service-manager">
        ...
        {hasRole(['BARBER', 'ADMIN', 'SUPER_ADMIN']) && (
          <>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-red-700">
                      <p>
                        {statsError}. As estatísticas serão atualizadas automaticamente quando a
            ...
            >
              ...
              <div
                data-testid="metric-today-appointments"
              ...
              <div
                data-testid="metric-week-revenue"
                className="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100"
              >
                <div className="p-6">
                  <div className="flex items-center">
              ...
              <div
                data-testid="metric-monthly-appointments"
                className="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100"
              >
                <div className="p-6">
                  <div className="flex items-center">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {hasRole('CLIENT') && (
                <button
                  ...
                  className="relative group bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6 hover:from-blue-100 hover:to-blue-200 transition-all duration-200"
                >
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-4">
                      <h4 className="text-sm font-semibold text-gray-900">Agendar Serviço</h4>
                ...
                <>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h4 className="text-sm font-semibold text-gray-900">Gerenciar Horários</h4>
                        <p className="text-sm text-gray-600">Configurar disponibilidade</p>
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h4 className="text-sm font-semibold text-gray-900">Serviços</h4>
                        <p className="text-sm text-gray-600">Configurar serviços</p>
                      </div>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className="relative group bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-6 hover:from-orange-100 hover:to-orange-200 transition-all duration-200"
                  >
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                      ...
                      <div className="ml-4">
                        <h4 className="text-sm font-semibold text-gray-900">Agendamentos</h4>
                        <p className="text-sm text-gray-600">Ver agenda do dia</p>
                      </div>
                    </div>
                  </button>
                </>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div
        data-testid={sidebarCollapsed ? 'sidebar-collapsed' : 'sidebar-expanded'}
        className={`${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            {!sidebarCollapsed && <h1 className="text-xl font-bold text-gray-900">SaaS Barber</h1>}
            <button
